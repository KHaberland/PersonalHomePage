...
BIO_EN = (
    "<p class='home-about-lead'>Welding engineer (IWE) with teaching experience "
    "and author of a book on MAG/MIG welding.</p>"
...
BIO_LV = (
    "<p class='home-about-lead'>Metināšanas inženieris (IWE) ar pasniegšanas "
    "pieredzi un grāmatas par MAG/MIG metināšanu autors.</p>"
...
class Migration(migrations.Migration):
    dependencies = [
        ("pages", "0008_about_bio_en_soldering"),
    ]
