...
- [ ] Оптимизация видео (формат, сжатие)
- [ ] Code splitting
- [ ] Оптимизация шрифтов
...
- [ ] Индустриальный стиль, минимализм
- [ ] Тёмный фон
- [ ] Яркие сварочные акценты (оранжевый, синий)
- [ ] Крупные заголовки и фотографии
- [ ] Адаптивная вёрстка (mobile-first)

### 4.2 Контент
- [ ] Подготовить текст для всех страниц на 3 языках
- [ ] Подобрать/создать фотографии
- [ ] Записать или подобрать видео сварки для Hero
- [ ] Написать первые статьи блога
